...
/** 
 * @author: 	xhf
 * @E-mail: 	xinghaifang@cdvcloud.com
 * @version：	v1.0 
 * @date:       2014年10月27日
 */
...
public final class JsonUtil {
	...
	public static TaskInfo readJSON2TaskInfo(String json){
		TaskInfo taskInfo = null;
		if (null != json && !"".equals(json)) {
			ObjectMapper objectMapper = new ObjectMapper();
			try {
				json  = replaceSpecialtyStr(json, "\t", "    ");//包含制表符的话 转换会失败。
				taskInfo = objectMapper.readValue(json, TaskInfo.class);
				//taskInfo = JSONObject.parseObject(json, TaskInfo.class);
			} catch (Exception e) {
				e.printStackTrace();
			} 
		}
	 ...
	 public static Map<Object,Object> jsonToMapObject(String json){
	 ...
	 public static boolean isBlankOrNull(String str){
		 if(null==str)return true;//return str.length()==0?true:false;  
		 return str.length()==0;
	 }
